    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">World Laptop Care</h3>
            <p className="text-gray-300 text-sm">
              Your trusted source for refurbished computers and laptops. Quality, affordability, and reliability in every device.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>Email: support@worldlaptopcare.com</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center text-sm text-gray-300">
          <p>&copy; 2024 World Laptop Care. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
